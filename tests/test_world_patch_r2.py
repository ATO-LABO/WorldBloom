...
from execution.world_patches import expanded_snapshot, patch_lock
...
from world_patch_fixtures import ROOT, frozen_experiment, write_approved
...
class Boundaries(unittest.TestCase):
    ...
    def test_status_and_disjoint_seeds(self):
        ...
        trial = {"runs": 3, "errors": [], "contract": {"violations": []},
                 "reproduction": {"checked": 1, "identical": 1}, "evidence": {
                    "base_source": "frozen_inputs", "engine_hash_experiment": "x", "engine_hash_trial": "x", "seeds": [1, 2, 3, 4]}}
